...
Now we prune the tree for interpretability by setting a maximum depth of 3 nodes:
...
Now we prune the tree for interpretability using a max depth of 3 nodes.
