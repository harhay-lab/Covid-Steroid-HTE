lbart.chained <- function(x.train, y.train, x.test=matrix(0.0,0,0),
  ...
  for (i in 1:nchains) {
    ...
    print("#################################################")
    print(paste("Chain Number:", i))

    currentchain <- lbart(x.train=x.train, y.train=y.train, x.test=x.test,
...
wbart.chained <- function(x.train, y.train, x.test=matrix(0.0,0,0),
  ...
  for (i in 1:nchains) {
    ...
    currentchain <- wbart(x.train=x.train, y.train=y.train, x.test=x.test,
